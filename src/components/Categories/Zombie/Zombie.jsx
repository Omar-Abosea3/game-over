...
export default function Zombie() {
    const [allGamesOnZombie, setallGamesOnZombie] = useState(null);
    ...
    return <>
      {allGamesOnZombie == null ? <LodingScrean/>: <div className="container py-5 px-3">
            <div className="row gy-3">
                  {allGamesOnZombie.map((game , index) =><div key={index} title={ "Available on "+ game.platform} className="col-lg-3 col-md-6 col-sm-12 col-12">
